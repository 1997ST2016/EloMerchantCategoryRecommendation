...
"""
Created on Thu Apr  4 10:53:57 2019
@author: xinyuweitian
"""
...
#reduce_mem_usage(df, verbose=True) 函数
...
#read the datas 
new_transactions = pd.read_csv('/home/xinyuweitian/Project/ProjectData/EloData/new_merchant_transactions.csv',
                               parse_dates=['purchase_date'],encoding='ISO-8859-1')

historical_transactions = pd.read_csv('/home/xinyuweitian/Project/ProjectData/EloData/historical_transactions.csv',
                                      parse_dates=['purchase_date'],encoding='gbk')
...
train = read_data('/home/xinyuweitian/Project/ProjectData/EloData/train.csv')
test = read_data('/home/xinyuweitian/Project/ProjectData/EloData/test.csv')
